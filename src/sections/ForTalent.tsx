  ...
  const benefits = [
    {
      ...
      description: "Learn from seasoned experts and leaders who are on the front lines of global change.",
      icon: "🎓"
    },
    {
      title: "Access the Network", 
      description: "Get direct access to a talent pool and network that is sought after by leading impact organizations, VCs, and public agencies.",
      icon: "🌐"
    },
    {
      title: "Create Lasting Change",
      description: "Gain the skills and connections to land a job where you can make a tangible and lasting contribution to the world.",
      icon: "🚀"
    }
  ];
    ...
    <div className="mx-auto w-full max-w-5xl px-6 py-12">
      ...
      <div className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600">
          You have the passion. We have the bridge. Launch your career in the impact sector with our three-month accelerator program.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-primary-blue p-8 text-center">
        ...
        <p className="mx-auto mb-6 max-w-xl text-lg text-white/80">
          Join our next cohort and start building the skills, network, and experience you need to make a real difference.
        </p>
